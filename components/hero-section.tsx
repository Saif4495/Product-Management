...
export function HeroSection() {
  const images = [
    "https://images.pexels.com/photos/6692447/pexels-photo-6692447.jpeg?auto=compress&cs=tinysrgb&w=1920",
    "https://images.pexels.com/photos/6489675/pexels-photo-6489675.jpeg?auto=compress&cs=tinysrgb&w=1920",
    "https://images.pexels.com/photos/6489721/pexels-photo-6489721.jpeg?auto=compress&cs=tinysrgb&w=1920",
    "https://images.pexels.com/photos/6489658/pexels-photo-6489658.jpeg?auto=compress&cs=tinysrgb&w=1920",
  ];

  return (
    <div className="relative min-h-screen overflow-hidden">
      <ImagesSlider className="h-screen" images={images} autoplay={true} direction="up">
        <motion.div
          initial={{
            opacity: 0,
            y: -80,
        ...
        >
          ...
          <div className="absolute -top-6 -right-6 text-pink-400 opacity-60">
            <Sparkles className="w-8 h-8 animate-float" style={{ animationDelay: '2s' }} />
          </div>
          <div className="absolute -bottom-4 -left-6 text-blue-400 opacity-50">
            <Sparkles className="w-5 h-5 animate-float" style={{ animationDelay: '4s' }} />
          </div>
          ...
          >
            Handcrafted designer candles with calming aesthetics. Transform your space with premium quality candles that ignite serenity and style.
          </motion.p>
